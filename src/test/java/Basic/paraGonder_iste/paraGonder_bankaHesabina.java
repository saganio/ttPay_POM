...
public class paraGonder_bankaHesabina extends baseClass {
    ...
    public void setUp() throws Exception {
        ...
        htmlReporter = new ExtentHtmlReporter("report\\basicReport/Para Gönder - Banka Hesabına.html");
        ...
        htmlReporter.config().setDocumentTitle("Para Gönder - Banka Hesabına");
        htmlReporter.config().setReportName("Para Gönder - Banka Hesabına");
