...
public class paraGonder_KayitliKisi extends baseClass {
    ...
    public void setUp() throws Exception {
        ...
        htmlReporter = new ExtentHtmlReporter("report\\basicReport/Para Gönder - Kayıtlı Kişi.html");
        ...
        htmlReporter.config().setDocumentTitle("Para Gönder - Kayıtlı Kişi");
        htmlReporter.config().setReportName("Para Gönder - Kayıtlı Kişi");
