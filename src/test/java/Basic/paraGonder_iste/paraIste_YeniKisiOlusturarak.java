...
public class paraIste_YeniKisiOlusturarak extends baseClass {
    ...
    public void setUp() throws Exception {
        ...
        htmlReporter = new ExtentHtmlReporter("report\\basicReport/Para İste - Yeni Kişi Oluşturarak.html");
        ...
        htmlReporter.config().setDocumentTitle("Para İste - Yeni Kişi Oluşturarak");
        htmlReporter.config().setReportName("Para İste - Yeni Kişi Oluşturarak");
