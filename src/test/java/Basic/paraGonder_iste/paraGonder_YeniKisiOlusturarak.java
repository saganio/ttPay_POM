...
public class paraGonder_YeniKisiOlusturarak extends baseClass {
    ...
    public void setUp() throws Exception {
        ...
        htmlReporter = new ExtentHtmlReporter("report\\basicReport/Para Gönder - Yeni Kişi Oluşturarak.html");
        ...
        htmlReporter.config().setDocumentTitle("Para Gönder - Yeni Kişi Oluşturarak");
        htmlReporter.config().setReportName("Para Gönder - Yeni Kişi Oluşturarak");
    ...
    public void step2() throws IOException {
        ...
        try {
            MobileElement menu = androidDriver.findElementById("tr.com.turktelekom.pokus.test:id/ibtn_user_home_fragment_send_money");
            menu.click();

            TTPay.log(Status.PASS, "Para Gönder'e tıklandı.");
    ...
    @Test
    public void step3() throws IOException, InterruptedException, ParseException {
